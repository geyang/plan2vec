...
class Args:
    ...
    # sample bias
    K = Proto(100, help="The regularizing constant for how far we consider neighbors.")
...
class LocalMetricConvXL(nn.Module):
    def __init__(self, input_dim, latent_dim):
        ...
        self.trunk = nn.Sequential(
            nn.Conv2d(input_dim * 2, 64, kernel_size=4, stride=2),
            nn.BatchNorm2d(64),
            nn.ReLU(),
...
def main(freeze_after=True, **kwargs):
    ...
    f_local_metric = LocalMetricConvXL(1, Args.latent_dim).to(Args.device)
