...
@cli_parse
class Config:
    sweep_root = "geyang/plan2vec/2019/07-22/streetlearn/plan2vec-2/gt_success"
...
if __name__ == "__main__":
    ...
    sweep_roots = [
        # "geyang/plan2vec/2019/07-19/streetlearn/plan2vec-2/gt_success_L1",
        # "geyang/plan2vec/2019/07-19/streetlearn/plan2vec-2/gt_success",
        # "geyang/plan2vec/2019/07-22/streetlearn/plan2vec/gt_success",
        # "geyang/plan2vec/2019/07-22/streetlearn/plan2vec/gt_success_L1",
        "geyang/plan2vec/2019/07-31/streetlearn/plan2vec/gt_success/binary",
        "geyang/plan2vec/2019/07-31/streetlearn/plan2vec/gt_success/non_binary",
        "geyang/plan2vec/2019/07-31/streetlearn/plan2vec/gt_success/gt_neighbor",
    ]
    ...
    for root in sweep_roots:
        ...
        jaynes.run(launch, sweep_root=root,
                   predicate=lambda df: ('run.status' in df) and df['run.status'] == 'running',
                   groupby=[
                       'Args.data_path',
                       # 'Args.coord_scaling',
                       'Args.binary_reward',
