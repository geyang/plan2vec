...
def common_config():
    ...
    Args.Lp = 1
    Args.eps_greedy = 0.5
    Args.sample_goal_r = 1.2e-4 * 15 * 20

    Args.num_epochs = 1500  # about 1.76 days / 500 steps
    # Args.lr = 3e-5
    Args.gamma = 0.97
    ...
    Args.checkpoint_after = 400  # start checkpointing in a day or so.
...
if __name__ == "__main__":
    ...
    r_scale_dict = {
        ...
        "small": 0.09,
        "tiny": 0.2,
        # "xl": 0.02,  # the ConvNet does not find the right neighbors.
    }
