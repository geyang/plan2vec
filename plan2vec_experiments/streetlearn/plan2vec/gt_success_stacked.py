...
def common_config():
    ...
    Args.num_epochs = 2000  # about 1.76 days
    Args.eps_greedy = 0.1
    Args.sample_goal_r = 1.2e-4 * 20
    ...
    Args.latent_dim = 10  # set to 10 to avoid the embeddings from triggering.
...
if __name__ == "__main__":
    ...
    Args.global_metric = 'ResNet18Stacked'
