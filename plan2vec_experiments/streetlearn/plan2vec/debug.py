...
def common_config():
    ...
    Args.num_epochs = 5  # about 1.76 days
    # Args.lr = 3e-5
    Args.gamma = 0.97
...
if __name__ == "__main__":
    ...
    for key in ['medium', 'large', 'xl']:
        for r in [1]:
            Args.lr = 3e-6
            # for Args.lr in [1e-6, 3e-6, 1e-5, 3e-5, 1e-4, 3e-4, 1e-3, 3e-3, 1e-2, 3e-2, 1e-1]:
            #     for n in [2.5]:
            ...
            # n = 1
            # for neighbor_r in [0.5, 0.8, 0.9, 1]:
