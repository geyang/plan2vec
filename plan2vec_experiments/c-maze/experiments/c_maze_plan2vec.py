...
def common_config():
    ...
    local_metric_exp_path = "episodeyang/plan2vec/2019/05-22/c-maze/c_maze_local_metric/18.16/05.549559"
...
if __name__ == "__main__":
    ...
    # only 400 and 600 works b/c small n_rollouts contain orphans.
    for Args.n_rollouts in [100, 140, 200, 400, 600]:
        # plan2vec()
